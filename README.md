...
| `0.14-0.27`          | master    | **`0.14.x`**  | **`0.27.x`** | `amd64`, `i386`, `arm64`                     |
|                      |           |               |              |                                              |
...
| `0.13-0.27`          | master    | **`0.13.x`**  | **`0.27.x`** | `amd64`, `i386`, `arm64`                     |
| `0.13-0.26`          | master    | **`0.13.x`**  | **`0.26.x`** | `amd64`, `i386`, `arm64`                     |
| `0.13-0.25`          | master    | **`0.13.x`**  | **`0.25.x`** | `amd64`, `i386`, `arm64`                     |
|                      |           |               |              |                                              |
| `0.12-0.24`          | master    | **`0.12.x`**  | **`0.24.x`** | `amd64`, `i386`, `arm64`                     |
| `0.12-0.23`          | master    | **`0.12.x`**  | **`0.23.x`** | `amd64`, `i386`, `arm64`                     |
| `0.12-0.22`          | master    | **`0.12.x`**  | **`0.22.x`** | `amd64`, `i386`, `arm64`                     |
| `0.12-0.21`          | master    | **`0.12.x`**  | **`0.21.x`** | `amd64`, `i386`, `arm64`                     |
| `0.12-0.20`          | master    | **`0.12.x`**  | **`0.20.x`** | `amd64`, `i386`, `arm64`                     |
| `0.12-0.19`          | master    | **`0.12.x`**  | **`0.19.x`** | `amd64`, `i386`, `arm64`                     |
|                      |           |               |              |                                              |
| `0.11-0.18`          | master    | **`0.11.x`**  | **`0.18.x`** | `amd64`, `i386`, `arm64`                     |
...
| `0.14-0.27-<tag>`    | tag: `<tag>` | **`0.14.x`**  | **`0.27.x`** | `amd64`, `i386`, `arm64`                     |
|                      |              |               |              |                                              |
...
| `0.13-0.27-<tag>`    | tag: `<tag>` | **`0.13.x`**  | **`0.27.x`** | `amd64`, `i386`, `arm64`                     |
| `0.13-0.26-<tag>`    | tag: `<tag>` | **`0.13.x`**  | **`0.26.x`** | `amd64`, `i386`, `arm64`                     |
| `0.13-0.25-<tag>`    | tag: `<tag>` | **`0.13.x`**  | **`0.25.x`** | `amd64`, `i386`, `arm64`                     |
|                      |              |               |              |                                              |
| `0.12-0.24-<tag>`    | tag: `<tag>` | **`0.12.x`**  | **`0.24.x`** | `amd64`, `i386`, `arm64`                     |
| `0.12-0.23-<tag>`    | tag: `<tag>` | **`0.12.x`**  | **`0.23.x`** | `amd64`, `i386`, `arm64`                     |
| `0.12-0.22-<tag>`    | tag: `<tag>` | **`0.12.x`**  | **`0.22.x`** | `amd64`, `i386`, `arm64`                     |
| `0.12-0.21-<tag>`    | tag: `<tag>` | **`0.12.x`**  | **`0.21.x`** | `amd64`, `i386`, `arm64`                     |
| `0.12-0.20-<tag>`    | tag: `<tag>` | **`0.12.x`**  | **`0.20.x`** | `amd64`, `i386`, `arm64`                     |
| `0.12-0.19-<tag>`    | tag: `<tag>` | **`0.12.x`**  | **`0.19.x`** | `amd64`, `i386`, `arm64`                     |
|                      |              |               |              |                                              |
| `0.11-0.18-<tag>`    | tag: `<tag>` | **`0.11.x`**  | **`0.18.x`** | `amd64`, `i386`, `arm64`                     |
